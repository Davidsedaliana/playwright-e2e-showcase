...
### Как выглядит настоящий прогон

![Реальный прогон: авторизация, каталог, корзина, оформление заказа](docs/tests-run.gif)

Четыре сценария из 19 UI-тестов, записанные с настоящего прогона `playwright test`
на saucedemo.com — живой браузер и живые проверки, без постановки.

### Экраны отчёта

| Обзор: 68 тестов, 100% зелёных | Тест со всеми шагами |
| --- | --- |
| ![Обзор](docs/allure-overview.jpg) | ![Шаги теста](docs/allure-test-steps.jpg) |
| **Графики: статусы, важность, длительность** | **Таймлайн параллельных воркеров** |
| ![Графики](docs/allure-graphs.jpg) | ![Таймлайн](docs/allure-timeline.jpg) |
